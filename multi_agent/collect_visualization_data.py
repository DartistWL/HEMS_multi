...
# 评估日期与训练日（07-03～07-09）不重叠；工作日/双休日分开（与 run_pv_evaluation 一致）
EVAL_DATES_WEEKDAY = ['2011-07-11', '2011-07-12']   # 周一、周二
EVAL_DATES_WEEKEND = ['2011-07-10', '2011-07-17']   # 周日
    ...
    if baseline.use_community_env:
        ...
        for date_type_label, eval_dates, pv_list in [
            ...
            for episode in range(num_episodes):
                ...
                states = baseline.eval_ma_env.reset(mode='eval', date_index=date_index)
                episode_data = {
