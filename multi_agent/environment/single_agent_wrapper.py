...
class SingleAgentWrapper:
    ...
    def __init__(self, agent_id, pv_coefficient=1.0,
        ...
        self.use_carbon_in_reward = use_carbon_in_reward
    ...
    def _init_env(self):
        ...
        self.env = HomeEnergyManagementEnv(
            ...
            use_carbon_in_reward=False,  # 传递
            episode_length_steps=48  # 添加这一行
        )
    ...
    def step(self, action, community_ess_power=0.0):
        ...
        if not isinstance(next_state, dict):
            print(f"ERROR: next_state is {type(next_state)}")
            next_state = {}
